...
def search_msAcademic(query, headers, _pages, records, _title, _keyword, _abstract, ms_api, _from_yr, _to_yr_,
                      logging_flag, data):
            ...
            for item in obj['entities']:
                try:
                    ...
                    resp_obj = {"entities": {"Search Engine": "Microsoft Academy",
                                             "Attributes found": "DOI, Title, URLs, Authors, Publication Name, Cited "
