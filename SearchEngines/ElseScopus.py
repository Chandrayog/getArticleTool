...
def search_scopus(query, headers, _els_pages, records, _title, _keyword, _abstract, scp_api, _from_yr, _to_yr_,
                  logging_flag, data):
            ...
            for item in obj['search-results']['entry']:
                try:
                    ...
                    resp_obj = {"entities": {"Search Engine": "Elsevier SCOPUS Search Engine",
                                             "Attributes found": "DOI, Title, URLs, Authors, Publication Name, ISSN, "
